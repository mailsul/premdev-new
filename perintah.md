...
Push github ke VPS
```
cd /opt/premdev && sudo git pull && sudo docker build -t ghcr.io/maraazn069/premdev:latest .
sudo docker compose -f /opt/premdev/docker-compose.yml up -d app
```

```
cd /opt/premdev && sudo git pull && sudo docker build -t ghcr.io/maraazn069/premdev:latest . && sudo docker compose -f /opt/premdev/docker-compose.yml up -d app
```
